module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-core-record'
                        // standalone: 'mitchallen.-marchio-core-record'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-core-record.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-core-record.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-core-record.min.js': ['./dist/marchio-core-record.js']
                }
            }
        },
